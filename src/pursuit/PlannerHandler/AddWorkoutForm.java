...
public class AddWorkoutForm extends javax.swing.JFrame {
    ...
    private void createConnection() {
        try {
            ...
            Logger.getLogger(AddWorkoutForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddWorkoutForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddWorkoutForm().setVisible(true);
            }
        });
    }
